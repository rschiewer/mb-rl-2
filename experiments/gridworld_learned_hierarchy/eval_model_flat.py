...
if __name__ == '__main__':
    ...
    parser.add_argument('id', type=str, nargs=2)
    ...
    if len(args.id) == 1:
        ...
        model_path = f'{cfg["final_model_path"]}_{args.id[1]}.ptmdl'

    env = Gridworld.from_cleartext(here() / '../../mdm/gridworld/9x8_v0.mapdata')
    ...
    planning_cfg['n_abstract_steps'] = ceil(51 / mdl.abstract_step_size) - planning_cfg['n_warmup_abstr']
